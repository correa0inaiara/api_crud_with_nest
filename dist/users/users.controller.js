...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOkResponse)({ description: 'Lista de todos os usuários.' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOkResponse)({ description: 'Detalhes do usuário encontrado.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({
        type: create_user_input_1.CreateUserInput,
...
__decorate([
    ...
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Usuário não encontrado.' }),
    (0, swagger_1.ApiBadRequestResponse)({ description: 'Solicitação inválida.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Usuário removido com sucesso.' }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Usuário não encontrado.' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
